...
const CoursePage = () => {
  ...
  //         for (const i of student.nonPreferences) {
  //           if (pref !== "Not Any") {
  //             break;
  //           }
  //           if (i === selectedCourse.name) {
  //             pref = `Not Preferred`;
  //             break;
  //           }
  //         }
  ...
  // const handlePrefFilter = (selectedPreferences) => {
  //   // Update your filtering logic here to handle multiple selected preferences
  //   // For example:
  //   const filteredStudents = allStudents.filter(student => 
  //     selectedPreferences.length === 0 || selectedPreferences.includes('All') || selectedPreferences.includes(student.preference)
  //   );
  ...
  //   setFilters((prevFilters) => ({
  //     ...prevFilters,
  //     preference: selectedOptions.length ? selectedOptions : ["All"] // Set to ["All"] if no options are selected
  //   }));
  // };
    ...
    <div>
      <div className="flex">
        ...
        <div className="flex items-center">
          ...
          <p className=" text-2xl flex mr-1">{currentRound}</p>
        </div>
      </div>
